...
if hash emacsclient 2>/dev/null; then
	...
	alias suet="SUDO_ASKPASS=\"/usr/lib/ssh/ssh-askpass\" SUDO_EDITOR=\"emacsclient -t -a emacs\" sudoedit -A"
	alias emacs="emacsclient -c -a emacs"
else
	export EDITOR="vim"
	export VISUAL="vim"
	alias et="vim"
	alias suet="SUDO_ASKPASS=\"/usr/lib/ssh/ssh-askpass\" SUDO_EDITOR=\"vim\" sudoedit -A"
fi
